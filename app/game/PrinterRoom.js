            ...
            <div style={{
              ...
              {gameState.printerQuality >= 100 && (
                <div style={{
                  ...
                  <div style={{ borderBottom: '1px solid #000', marginBottom: '4px', paddingBottom: '2px' }}>ERROR: JAM 882</div>
                  <div>SEE CASE-882</div>
                  <div style={{ fontSize: '9px', marginTop: '4px' }}>IN ARCHIVE</div>
                </div>
              )}
            </div>
