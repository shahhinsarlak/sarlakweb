...
export const GEAR_BLUEPRINTS = [
  { id: 'lantern', family: 'instrument', name: 'Lantern', stat: 'sight', value: 12, research: { intelligence: 30 }, craft: { sec: { pp: 12 }, floor: { pp: 200 }, core: 'static_crystal', coreQty: 2 }, desc: 'Lights the dark: raises Sight and reveal radius. Required to venture into deep tiers.', lore: 'A desk lamp lashed to a fire-extinguisher harness, running off a stolen battery. Its light falls a little wrong, but it falls far.' },
  { id: 'compass', family: 'instrument', name: 'Compass', stat: 'sight', value: 7, research: { intelligence: 45 }, craft: { sec: { pp: 14 }, floor: { pp: 250 }, core: 'glitch_shard', coreQty: 2 }, desc: 'Steadier charting: fewer lost routes, better node detection. Counts as a light for deep tiers.', lore: 'A staple bent over a magnetised paperclip floating in a coffee lid. It does not point north. It points the way back, which is more useful.' },
  { id: 'decoder', family: 'instrument', name: 'Decoder Lens', stat: 'decode', value: 1, research: { intelligence: 90 }, craft: { sec: { pp: 20 }, floor: { pp: 400 }, core: 'reality_dust', coreQty: 1 }, desc: 'Identifies what waits at a site before you Delve, and is REQUIRED to read Echoes.', lore: 'A loupe ground from a cracked monitor filter. Hold it to the static and the static holds still, just long enough to be read.' },
  { id: 'ward_minor', family: 'ward', name: 'Paper Ward', stat: 'wardstrength', value: 10, research: { intelligence: 60 }, craft: { sec: { pp: 16 }, floor: { pp: 300 }, core: 'glitch_shard', coreQty: 3 }, desc: 'A guard against Corruption. Required to Delve Corruptors, Anomalies and Gateways.', lore: 'Pages of meeting minutes folded into a chain of charms, each one stamped CONFIDENTIAL. The words mean nothing now. The folding means everything.' },
  { id: 'ward_major', family: 'ward', name: 'Lucid Ward', stat: 'wardstrength', value: 22, research: { intelligence: 160 }, craft: { sec: { pp: 25 }, floor: { pp: 600 }, core: 'temporal_core', coreQty: 1 }, desc: 'A strong guard: greatly cuts Corruption and permanent-loss odds.', lore: 'A halo of distiller-glass beaded with condensed lucidity. Worn at the brow, it keeps the mind convinced it is still itself, even when the dark insists otherwise.' },
  { id: 'plating', family: 'plating', name: 'Shell Plating', stat: 'shellhp', value: 40, research: { intelligence: 50 }, craft: { sec: { pp: 16 }, floor: { pp: 350 }, core: 'static_crystal', coreQty: 4 }, desc: 'Bolt-on armour: nearly doubles shell integrity, surviving far heavier combat.', lore: 'Filing-cabinet drawers hammered flat and riveted into a carapace. It rattles when the shell walks. The rattle is almost a comfort.' },
];
