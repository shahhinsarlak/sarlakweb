...
export const ACHIEVEMENTS = [
  ...
  { id: 'complete_archivist', name: 'Forbidden Knowledge', desc: 'Examine all 29 books in The Archive', check: (state) => state.examinedArchiveItems?.length >= 29 },
  ...
  { id: 'prophet', name: 'Prophet', desc: 'Print your first prophecy', check: (state) => (state.documentMastery?.prophecies || 0) >= 1 },
